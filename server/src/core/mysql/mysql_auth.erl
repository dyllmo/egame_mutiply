...
make_auth (User, Password) ->
    Caps = ?LONG_PASSWORD bor ?LONG_FLAG bor ?FOUND_ROWS bor ?TRANSACTIONS,
    Maxsize = 0,
    UserB = list_to_binary(User),
    PasswordB = Password,
    <<Caps:16/little,Maxsize:24/little,UserB/binary,0:8,PasswordB/binary>>.
...
make_new_auth (User, Password, Database) ->
	...
	?PROTOCOL_41 bor ?SECURE_CONNECTION bor DBCaps bor 
	?CLIENT_MULTI_STATEMENTS bor ?CLIENT_MULTI_RESULTS bor ?FOUND_ROWS,
